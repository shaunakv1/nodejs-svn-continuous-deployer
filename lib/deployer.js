 ...
 * @param {bolean}   enabled      used for unit testing. Should always pass true,except when you know what you are doing :)
...
function Deployer(enabled,project,svn,deployConfig,cb){
     if(enabled){
